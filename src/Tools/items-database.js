...
import news_2 from "../assets/news_4.webp";
import news_3 from "../assets/news_5.webp";
import btc from "../assets/btc 1.svg";
import bnb from "../assets/bnb 1.svg";
import busd from "../assets/busd 1.svg";
...
export const accordionContent = [
  ...
  },
  {
    ...
    ol_1: "1. Value Locking Mechanism: - The value locked within the TWINE token is determined by the number of TWINE tokens minted. Each new minting of a TWINE token increases the price of the BOND by a constant amount of 0.0000001.",
...
export const dropdownTokens = [
  ...
  { id: "btc", name: "BTC", icon: btc },
  { id: "eth", name: "ETH", icon: eth },
  { id: "busd", name: "BUSD", icon: busd },
